...
public class SimplePublishPortable {
    ...
    public void publish() {
        try {
            ...
            getAuthTokenMyPub.setUserID("lol");                    //your username
            getAuthTokenMyPub.setCred("lol");                          //your password
            ...
            myServName.setValue("TeamsService");
            ...
            accessPoint.setValue("http://localhost:8080/TeamsService?wsdl");
