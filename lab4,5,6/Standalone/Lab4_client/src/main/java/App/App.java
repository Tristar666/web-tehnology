...
public class App {
    private static final String URL = "http://localhost:8080/rest/teams";
    ...
    private static void showTeam(){ 
        ...
        try {
            ...
            GenericType<List<Team>> type = new GenericType<List<Team>>() {};      
            List<Team> teams = response.getEntity(type);
            for (Team team : teams) {
